...
?>
        ...
        <section class="home_image" id="im">
            ...
            $quary = "SELECT * FROM movie WHERE categorie ='Main movie' AND status='active'";
        ...
        <section class="now-show" id="movie1">
            ...
            <div class="movie-content">
                ...
                $quary = "SELECT * FROM movie WHERE categorie ='Second movie' AND status='active'";
                $quary_run = mysqli_query($connection,$quary);
        ...
        <selection class="upcoming-show" id="movie2">
            ...
            <div class="upcoming-movie swiper">
                <div class="swiper-wrapper">
                    ...
                    $quary = "SELECT * FROM movie WHERE categorie ='Upcoming movie' AND status='active'";
                    $quary_run = mysqli_query($connection,$quary);
        ...
        <section class="populer-movie" id="movie3">
            ...
            <div class="upcoming-movie swiper">
                ...
                $quary = "SELECT * FROM movie WHERE categorie ='Populer movie' AND status='active'";
                $quary_run = mysqli_query($connection,$quary);
