...
<body>
    ...
    <section class="main-movie-image" id="im">
        <?php
            ...
            $query = "SELECT * FROM movie WHERE categorie ='Second movie'";
            ...
            $query2 = "SELECT * FROM show_table WHERE categorie ='Second movie' AND movie_name='$movie_title'";
    ...
    <section class="movie-booking">  
        <form name="form" action="mmovie_bd.php" method="POST">
            <?php
                $name=$movie_title;
                $query = "SELECT * FROM show_table WHERE categorie ='Second movie' AND movie_name='$name' AND status='active'";
                $query_run = mysqli_query($connection,$query);
