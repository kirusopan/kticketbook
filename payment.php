...
<head>
    ...
    <link rel="stylesheet" href="css/paymentpp.css">
...
<div class="row1">
        ...
        <?php include('error.php'); ?>
            ...
            <form action="message.php" method="POST" class="payment">
                    ...
                    <input type="hidden" name="seat_name" value="<?php echo $seat_name?>">
                    ...
                    <div class="payline2">
                        <div class="phone-nu">
                            ...
                            <input type="date" class="date" name="ex_date" placeholder="Expiration Date" >
                        </div>
                        <div class="cvv">
                            <input type="number" class="cvv" name="cvv" placeholder="CVV" >
                        </div>
                    </div>
